        ...
        <div style={{ width: '100%', maxWidth: 440 }}>
          ...
          >
            ...
            <p style={{ fontSize: 12, color: C.textMuted, margin: '0 0 16px' }}>
              Start visualizing live code execution, pointers, and concurrency in 30 seconds.
            </p>
            ...
            >
                ...
                <div style={{ marginTop: 6 }}>
                  ...
                  >
                    {[...Array(4)].map((_, i) => (
                      <div
                        key={i}
                        style={{ borderRadius: 9999, backgroundColor: C.primary, height: '100%' }}
                      />
                    ))}
                  </div>
                  <div
                  ...
                  >
                    <span
                      style={{ color: C.primary, display: 'flex', alignItems: 'center', gap: 4 }}
                    >
                      <Check size={10} /> Strong password: 12+ chars, symbol, number
                    </span>
                    <span style={{ color: C.textMuted }}>84-bit</span>
                  </div>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6, marginTop: 2 }}>
                ...
                >
                  <input type="checkbox" defaultChecked style={{ accentColor: C.primary }} />
                  <span>Send me weekly visual algorithm breakdowns</span>
                </label>
              </div>
            ...
            <div
              style={{
                ...
                padding: '8px 12px',
                borderRadius: 10,
                backgroundColor: `${C.surfaceContainerHigh}99`,
                marginTop: 12,
              }}
            >
              <span
              ...
              />
              <span style={{ fontSize: 11, color: C.onSurface }}>
                Includes free forever tier:{' '}
                <strong style={{ color: C.textHeading }}>10 WASM sandboxes</strong> &amp; roadmaps.
              </span>
            </div>
            ...
            >
              🛡 Secured by Better Auth. Ed25519 encrypted session.
            </p>
          </div>
        </div>
      </div>
