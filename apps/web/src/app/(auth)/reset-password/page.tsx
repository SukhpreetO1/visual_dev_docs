...
import { Eye, EyeOff, ArrowRight, ArrowLeft, Check, KeyRound } from 'lucide-react';
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 10 }}>
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            >
              ...
              />
              SECURE CREDENTIAL RE-AUTHENTICATION
            </div>
            <h1
              style={{
                fontFamily: "'Plus Jakarta Sans', sans-serif",
            ...
            <p style={{ fontSize: 13, color: C.textMuted, lineHeight: 1.6, margin: 0 }}>
              Create a fresh 12+ character password to restore your sandbox access.
            </p>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {[
              {
                icon: '🔑',
                text: 'Salted bcrypt & Argon2 password hashing standard',
                color: C.primary,
              },
              {
                icon: '🔒',
                text: 'All active sessions automatically invalidated on update',
        ...
        >
          ...
          <p style={{ fontSize: 11, color: C.textMuted, fontStyle: 'italic', margin: 0 }}>
            &ldquo;Zero-downtime authentication security built for mission-critical labs.&rdquo;
          </p>
        </div>
      </div>
                  ...
                  <div>
                    ...
                    <div style={{ position: 'relative' }}>
                      ...
                      <input
                        ...
                        defaultValue="RustNewPassword2025#"
                        style={{
                          width: '100%',
                    ...
                    <div style={{ marginTop: 6 }}>
                      ...
                      >
                        ...
                        >
                          <Check size={10} /> Strong password
                        </span>
                        <span style={{ color: C.textMuted }}>84-bit entropy</span>
                      </div>
                    </div>
                  </div>
