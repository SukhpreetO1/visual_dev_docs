...
export default function LearnTopicPage({ params: _params }: PageProps) {
  ...
  const codeLines = [
    {
      ...
      content: (
        <>
          ...
          <span style={{ color: '#85f8c4' }}>inorder</span>(node):
        </>
      ),
      bg: null,
    },
    {
      ...
      content: (
        <>
          &nbsp;&nbsp;<span style={{ color: C.primary }}>if</span> node{' '}
          <span style={{ color: C.primary }}>is</span>{' '}
          <span style={{ color: C.tertiary }}>None</span>:
        </>
      ),
      bg: null,
    },
    {
      ...
      content: (
        <>
          &nbsp;&nbsp;&nbsp;&nbsp;<span style={{ color: C.primary }}>return</span>
        </>
      ),
      bg: null,
    },
    { n: '04', content: <></>, bg: null },
    {
      ...
      content: (
        <>
          &nbsp;&nbsp;<span style={{ color: C.primary }}>inorder</span>(node.
          <span style={{ color: C.onSurface }}>left</span>)
          <span style={{ color: C.textMuted }}>&nbsp;&nbsp;# ← Recurse Left</span>
        </>
      ),
      bg: `${C.primary}22`,
    },
    {
      ...
      content: (
        <>
          &nbsp;&nbsp;<span style={{ color: '#85f8c4' }}>print</span>(node.
          <span style={{ color: C.secondary }}>val</span>)
          <span style={{ color: C.textMuted }}>&nbsp;&nbsp;# Visit Node</span>
        </>
      ),
      bg: `${C.primary}3A`,
    },
    {
      ...
      content: (
        <>
          &nbsp;&nbsp;<span style={{ color: C.primary }}>inorder</span>(node.
          <span style={{ color: C.onSurface }}>right</span>)
          <span style={{ color: C.textMuted }}>&nbsp;&nbsp;# → Recurse Right</span>
        </>
      ),
      bg: null,
    },
    { n: '08', content: <></>, bg: null },
    {
      ...
      content: (
        <>
          <span style={{ color: C.primary }}>class</span>{' '}
          <span style={{ color: C.secondary }}>TreeNode</span>:
        </>
      ),
      bg: null,
    },
    {
      ...
      content: (
        <>
          &nbsp;&nbsp;<span style={{ color: C.primary }}>def</span>{' '}
          <span style={{ color: '#85f8c4' }}>__init__</span>(
          <span style={{ color: C.tertiary }}>self</span>, val=
          <span style={{ color: C.tertiary }}>0</span>, left=
          <span style={{ color: C.tertiary }}>None</span>, right=
          <span style={{ color: C.tertiary }}>None</span>):
        </>
      ),
      bg: null,
    },
    {
      ...
      content: (
        <>
          &nbsp;&nbsp;&nbsp;&nbsp;<span style={{ color: C.tertiary }}>self</span>.
          <span style={{ color: C.secondary }}>val</span> = val
        </>
      ),
      bg: null,
    },
    {
      ...
      content: (
        <>
          &nbsp;&nbsp;&nbsp;&nbsp;<span style={{ color: C.tertiary }}>self</span>.
          <span style={{ color: C.secondary }}>left</span> = left;{' '}
          <span style={{ color: C.tertiary }}>self</span>.
          <span style={{ color: C.secondary }}>right</span> = right
        </>
      ),
      bg: null,
    },
    { n: '13', content: <></>, bg: null },
    {
      ...
      content: (
        <>
          <span style={{ color: C.textMuted }}># Build & run</span>
        </>
      ),
      bg: null,
    },
    {
      ...
      content: (
        <>
          <span style={{ color: C.primary }}>root</span> = TreeNode(
          <span style={{ color: C.tertiary }}>4</span>)
        </>
      ),
      bg: null,
    },
    {
      ...
      content: (
        <>
          <span style={{ color: C.primary }}>inorder</span>(root){' '}
          <span style={{ color: C.textMuted }}># → 1 2 3 4 5 6 7</span>
        </>
      ),
      bg: null,
    },
      ...
      >
        ...
        <div
          style={{
            ...
            borderRight: `1px solid ${C.surfaceContainerHigh}`,
            overflow: 'auto',
            display: 'flex',
            flexDirection: 'column',
          }}
        >
          ...
          <div style={{ padding: '16px', borderBottom: `1px solid ${C.surfaceContainerHigh}` }}>
            ...
            <p style={{ fontSize: 13, color: C.onSurfaceVariant, lineHeight: 1.7, margin: 0 }}>
              Recursively visits the <strong style={{ color: C.primary }}>left subtree</strong>,
              then processes the <strong style={{ color: C.secondary }}>root node</strong>, then the{' '}
              <strong style={{ color: C.primary }}>right subtree</strong>. For a BST, this produces
          ...
          <div style={{ padding: '16px', borderBottom: `1px solid ${C.surfaceContainerHigh}` }}>
            ...
            >
              <p style={{ color: C.primary, margin: '0 0 4px', fontWeight: 600 }}>
                → Entering: inorder(node=Node(6))
              </p>
              <p style={{ color: C.textMuted, margin: '0 0 4px' }}>
                node.left = Node(5) [unvisited]
              </p>
          ...
          <div style={{ padding: '16px', flex: 1, display: 'flex', flexDirection: 'column' }}>
            ...
            >
              💡{' '}
              <strong style={{ color: C.primary }}>Why does in-order produce sorted output?</strong>
              <br />
              For a BST, left children are always smaller. Visiting left first means smaller values
              are always processed before larger ones, producing ascending order.
            </div>
                ...
                {treeNodes.map(({ id, x, y, val, active, done, label }) => (
                  <g key={id}>
                    <circle
                      ...
                      stroke={
                        active ? C.primary : done ? `${C.primary}80` : C.surfaceContainerHighest
                      }
                    ...
                    <text
                      fill={active ? C.textHeading : done ? C.primary : C.textMuted}
              ...
              {callStackFrames.map(({ label, color, active }, i) => (
                <div
                  ...
                  style={{
                    ...
                    padding: '6px 10px',
                    borderRadius: 6,
                    backgroundColor: active ? `${C.primary}1A` : C.surfaceContainerHigh + '99',
                  }}
                >
                  <span
                    style={{
        ...
        <div
          style={{
            backgroundColor: C.surfaceContainerLowest,
            borderLeft: `1px solid ${C.surfaceContainerHigh}`,
            display: 'flex',
            flexDirection: 'column',
            overflow: 'hidden',
          }}
            ...
            {codeLines.map(({ n, content, bg }) => (
              <div
                ...
                style={{
                  ...
                  paddingLeft: bg ? 12 : undefined,
                  paddingRight: bg ? 12 : undefined,
                }}
              >
                <span
                  style={{
              ...
              {(['stdout', 'watch', 'profiler'] as const).map((tab) => (
                <button
                  ...
                  style={{
                    ...
                    backgroundColor: activeTab === tab ? C.surfaceContainerHigh : 'transparent',
                    color: activeTab === tab ? C.primary : C.textMuted,
                    borderBottom:
                      activeTab === tab ? `2px solid ${C.primary}` : '2px solid transparent',
                  }}
                >
                  {tab}
                </button>
              ...
              {activeTab === 'stdout' && (
                <>
                  <p style={{ color: C.textMuted, margin: 0 }}>
                    [0.01ms] VM bootstrapped at heap: 0x00A40
                  </p>
                  <p style={{ color: C.textMuted, margin: 0 }}>
                    [0.04ms] inorder(root) called — root.val = 4
                  </p>
                  <p style={{ color: C.textMuted, margin: 0 }}>
                    [0.07ms] → recurse left: inorder(node.val=2)
                  </p>
                  <p style={{ color: C.textMuted, margin: 0 }}>
                    [0.11ms] → recurse left: inorder(node.val=1)
                  </p>
                  <p style={{ color: C.primary, margin: 0, fontWeight: 600 }}>
                    [0.14ms] print(1) → OUTPUT: 1
                  </p>
                  <p style={{ color: C.primary, margin: 0, fontWeight: 600 }}>
                    [0.18ms] print(2) → OUTPUT: 2
                  </p>
                  <p style={{ color: C.primary, margin: 0, fontWeight: 600 }}>
                    [0.22ms] print(3) → OUTPUT: 3
                  </p>
                  <p style={{ color: C.primary, margin: 0, fontWeight: 600 }}>
                    [0.25ms] print(4) → OUTPUT: 4
                  </p>
                  <p style={{ color: C.secondary, margin: 0, fontWeight: 600 }}>
                    [0.28ms] ▶ Step {step} — Entering Node(6)...
                  </p>
                </>
              )}
              {activeTab === 'watch' && (
