...
const roadmapNodes: RoadmapNode[] = [
  {
    ...
    subtitle: 'Process model, file system hierarchy, bash scripting',
    status: 'done',
    duration: '4h 20m',
    column: 'fundamentals',
    tags: ['Core', 'Bash', 'POSIX'],
  },
  {
    id: 2,
    title: 'Networking & DNS Internals',
    subtitle: 'TCP/IP stack, TLS handshakes, DNS resolution graph',
    status: 'done',
    duration: '5h 10m',
    column: 'fundamentals',
    tags: ['Core', 'TCP', 'DNS'],
  },
  {
    ...
    subtitle: 'GitHub Actions, ArgoCD, deployment strategies',
    status: 'active',
    duration: '6h 30m',
    column: 'fundamentals',
    tags: ['Core', 'CI/CD', 'GitOps'],
  },
  {
    id: 4,
    title: 'Infrastructure as Code (Terraform)',
    subtitle: 'Provider graph, state management, remote backends',
    status: 'available',
    duration: '7h 15m',
    column: 'fundamentals',
    tags: ['Advanced', 'HCL', 'AWS'],
  },
  {
    id: 5,
    title: 'Observability & SRE Practices',
    subtitle: 'SLI/SLO, distributed tracing, alerting architecture',
    status: 'locked',
    duration: '8h 00m',
    column: 'fundamentals',
    tags: ['SRE', 'Prometheus', 'Grafana'],
  },
  {
    id: 6,
    title: 'Docker & Container Runtimes',
    subtitle: 'OCI spec, overlay FS, namespaces and cgroups',
    status: 'done',
    duration: '5h 45m',
    column: 'containers',
    tags: ['Core', 'Docker', 'OCI'],
  },
  {
    id: 7,
    title: 'Kubernetes Core Architecture',
    subtitle: 'etcd, kube-apiserver, scheduler, controller loop',
    status: 'active',
    duration: '9h 00m',
    column: 'containers',
    tags: ['Core', 'k8s', 'etcd'],
  },
  {
    ...
    subtitle: 'Envoy proxy, mTLS, traffic policies, observability',
    status: 'available',
    duration: '6h 20m',
    column: 'containers',
    tags: ['Advanced', 'Istio', 'mTLS'],
  },
  {
    id: 9,
    title: 'Helm & GitOps Delivery',
    subtitle: 'Chart templating, FluxCD, ArgoCD sync loops',
    status: 'locked',
    duration: '4h 50m',
    column: 'containers',
    tags: ['GitOps', 'Helm', 'Flux'],
  },
  {
    id: 10,
    title: 'Multi-cloud & Cost Optimization',
    subtitle: 'FinOps, Spot instances, multi-region architecture',
    status: 'locked',
    duration: '5h 30m',
    column: 'containers',
    tags: ['Specialization', 'FinOps', 'AWS'],
  },
];
...
export default function RoadmapPage({ params: _params }: PageProps) {
          ...
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  ...
                  {roadmapNodes.map((n) => (
                    <div
                      ...
                      style={{
                        ...
                        boxShadow: n.status === 'done' ? '0 0 6px rgba(104,219,169,0.4)' : 'none',
                      }}
                    />
                  ))}
                </div>
                ...
                >
                  {completedCount}/{roadmapNodes.length} completed
                </span>
              </div>
              <div
                style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <button
              style={{
                ...
                fontWeight: 700,
                cursor: 'pointer',
                boxShadow: '0 0 16px rgba(104,219,169,0.25)',
              }}
            >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32 }}>
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 20 }}>
                ...
                >
                  {fundamentalNodes.filter((n) => n.status === 'done').length}/
                  {fundamentalNodes.length}
                </span>
              </div>
              <div
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          border: `2px solid ${statusBorder(node.status)}`,
                          display: 'flex',
                          alignItems: 'center',
                          justifyContent: 'center',
                          flexShrink: 0,
                          ...
                          boxShadow:
                            node.status === 'done'
                              ? '0 0 12px rgba(104,219,169,0.3)'
                              : node.status === 'active'
                                ? '0 0 12px rgba(246,96,24,0.3)'
                                : 'none',
                        }}
                      >
                        ...
                        >
                          <h3
                            style={{
                              ...
                              fontSize: 14,
                              fontWeight: 600,
                              color: node.status === 'locked' ? C.textMuted : C.textHeading,
                              margin: 0,
                              lineHeight: 1.3,
                            }}
                          >
                          ...
                          {node.status === 'active' && (
                            <span
                              style={{
                                padding: '1px 6px',
                                borderRadius: 4,
                                backgroundColor: `${C.secondary}26`,
                                color: C.secondary,
                                fontFamily: "'JetBrains Mono', monospace",
                                fontSize: 10,
                                fontWeight: 600,
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 20 }}>
                ...
                >
                  {containerNodes.filter((n) => n.status === 'done').length}/{containerNodes.length}
                </span>
              </div>
              <div
                style={{ display: 'flex', flexDirection: 'column', gap: 0, position: 'relative' }}
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
                  <div
                    style={{
                      ...
                      border: `2px solid ${statusBorder(selectedNode.status)}`,
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                    }}
                  ...
                  {selectedNode.id > 1 && (
                    ...
                    >
                      ...
                      <span style={{ fontSize: 13, color: C.onSurface }}>
                        Stage {selectedNode.id - 1} — {roadmapNodes[selectedNode.id - 2]?.title}
                      </span>
                    </div>
                  )}
                  {selectedNode.id === 1 && (
              ...
              {selectedNode.status === 'locked' ? (
                ...
                >
                  ...
                  <p style={{ fontSize: 13, color: C.textMuted, margin: 0 }}>
                    Complete previous stages to unlock this topic.
                  </p>
                </div>
              ) : (
                <button
                  style={{
                    ...
                    border: 'none',
                    backgroundColor:
                      selectedNode.status === 'done' ? C.surfaceContainerHigh : C.primary,
                    color: selectedNode.status === 'done' ? C.onSurface : C.onPrimary,
                    fontFamily: "'Plus Jakarta Sans', sans-serif",
                    fontWeight: 700,
                    fontSize: 15,
                    cursor: 'pointer',
                    boxShadow:
                      selectedNode.status !== 'done' ? '0 0 20px rgba(104,219,169,0.3)' : 'none',
                  }}
                >
                  {selectedNode.status === 'done' ? (
                    <>
